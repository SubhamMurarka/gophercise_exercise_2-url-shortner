...
import (
	...
	"github.com/ShubhamMurarka/url-shortner/api/database"
	"github.com/ShubhamMurarka/url-shortner/api/helper"
	...
	if err == redis.Nil {
		...
		if valInt <= 0 {
			...
			return c.Status(fiber.StatusServiceUnavailable).JSON(fiber.Map{
				...
				"rate_limit_reser": limit / time.Nanosecond / time.Minute,
			})
		}
	}
